...
var SGPlusV2 = {
    ...
    generateGridview: function (root) {
        ...
        $(root).find('.giveaway-summary-inner-wrap').each(function () {
            ...
            $(gridview_extra).append('<div class="giveaway-summary__heading__name small_text">' + giveawayName +  '</div>');
