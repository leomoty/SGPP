...
(function (ModuleDefinition) {
    var EntryCommenters = (function () {
        ...
        EntryCommenters.prototype.render = function () {
            var $pos = $(document.createElement('i')).addClass('GAComm_pos fa fa-comment-o').attr('title', 'Commented');
            var $neg = $(document.createElement('span')).addClass('GAComm_neg fa-stack').attr('title', 'Did not comment').append($(document.createElement('i')).addClass('fa fa-comment-o fa-stack-1x')).append($(document.createElement('i')).addClass('fa fa-times fa-stack-1x'));
